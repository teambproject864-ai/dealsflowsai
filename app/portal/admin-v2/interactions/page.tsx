...
export default function AdminV2Interactions() {
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-16">
        ...
        <h3 className="text-lg font-semibold text-slate-300 mb-2">Interactions Page</h3>
        <p className="text-slate-500 mb-4">
          Coming soon! Use the legacy portal to access interactions.
        </p>
