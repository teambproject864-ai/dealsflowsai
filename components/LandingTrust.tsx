...
export function LandingTrust() {
  return (
    <section className="border-t border-white/10 bg-gradient-to-b from-transparent to-indigo-950/20">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3 text-xs text-muted-foreground">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 px-3 py-1">
                <Shield className="h-3.5 w-3.5 text-violet-400" /> SOC2-ready
                patterns
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 px-3 py-1">
                <Zap className="h-3.5 w-3.5 text-amber-400" /> Sub-second
                orchestration
              </span>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 px-3 py-1">
                <Sparkles className="h-3.5 w-3.5 text-sky-400" /> Hugging Face
                insights
              </span>
            </div>
          </div>
